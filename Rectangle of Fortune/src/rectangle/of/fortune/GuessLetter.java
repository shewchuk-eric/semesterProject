...
public class GuessLetter {
    ...
    public void GuessWord() { // This will be changed later to allow for selection of number of players
        String secretWord = "cricket";//In the future, this will be replaced with an array of words. We will also need to differentiate between upper and lowercase.
